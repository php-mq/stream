...
namespace PHPMQ\Stream\Tests\Unit;

use PHPMQ\Stream\Stream;
use PHPMQ\Stream\Tests\Unit\Fixtures\Traits\SocketMocking;
use PHPMQ\Stream\Tests\Unit\Fixtures\Traits\StreamIdentifierMocking;
...
final class StreamTest extends TestCase
{
	...
	/**
	 * @expectedException \PHPMQ\Stream\Exceptions\ReadTimedOutException
	 */
	...
	/**
	 * @expectedException \PHPMQ\Stream\Exceptions\WriteTimedOutException
	 */
